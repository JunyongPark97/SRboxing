"""
Django settings for SRboxing project.
...
SECRET_KEY = '+zexl&curhywsookx2+qd%o!h^_)1skfjwlsnt%l2_rant3t'
...
WSGI_APPLICATION = 'SRboxing.wsgi.application'
